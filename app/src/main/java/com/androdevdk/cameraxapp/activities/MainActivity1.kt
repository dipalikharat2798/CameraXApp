...
import com.androdevdk.cameraxapp.MainActivity
import com.androdevdk.cameraxapp.R
import com.androdevdk.cameraxapp.adapter.CameraAdapter
...
class MainActivity1 : AppCompatActivity(), CustomAdapter.RecyclerImageClick {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mainHeading_tvm1.setText(title.get(count))
        // Set up the listener for take photo button
        ...
        saveAndNext_btnm1.setOnClickListener() {
           ...
           retake_btnm1.setVisibility(View.GONE)
            ...
            if (count < 5) {
                ...
                finish_btnm1.setVisibility(View.VISIBLE)
